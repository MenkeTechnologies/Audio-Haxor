...
//! (toasts, menus, tray, HTML `data-i18n*`, dialogs). Locales `cs`, `da`, `de`, `es`, `sv`, `fr`, `nl`, `pt`, `it`, `el`, `pl`, `ru`, `zh`, `ja`, `ko`, `fi`, `nb`, `tr`, `hu`, `ro`, `uk`, `vi` add rows with the same keys.
...
mod tests {
    use super::{
        ...
        SEED_JSON_RU, SEED_JSON_SV, SEED_JSON_TR, SEED_JSON_UK, SEED_JSON_VI, SEED_JSON_ZH,
    };
    use regex::Regex;
    ...
    #[test]
    fn seed_json_appfmt_placeholders_preserved_de_el_es_fi_fr_it_nl_pl_pt_ru_sv_zh_ja_ko_da_nb_tr_cs_hu_ro_uk_vi(
    ) {
        let en: HashMap<String, String> = serde_json::from_str(SEED_JSON_EN).expect("en json");
        for (loc, json) in [
            ("de", SEED_JSON_DE),
