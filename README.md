...
frontend/
  ...
  js/
    ...
    xref.js            -- Plugin ↔ DAW cross-reference UI + project viewer (10 formats); **Plugin Index** shows an immediate toast + global progress while projects load and parse
