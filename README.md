...
src-tauri/
  ...
  tauri.conf.json      -- Tauri app configuration + CSP (`worker-src 'self'` for same-origin workers) + bundling + `externalBin` for `binaries/audio-engine`
