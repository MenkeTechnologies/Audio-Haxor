...
function restoreSettings() {
  ...
  if (
    localeSel &&
    (uiLoc === 'de' || uiLoc === 'es' || uiLoc === 'sv' || uiLoc === 'fr' || uiLoc === 'nl' || uiLoc === 'pt' || uiLoc === 'it' || uiLoc === 'el' || uiLoc === 'pl' || uiLoc === 'ru' || uiLoc === 'zh' || uiLoc === 'ja' || uiLoc === 'ko' || uiLoc === 'fi' || uiLoc === 'da' || uiLoc === 'nb' || uiLoc === 'tr' || uiLoc === 'en')
  ) {
