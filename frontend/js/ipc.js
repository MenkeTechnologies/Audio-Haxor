...
window.vstUpdater = {
    ...
    /** Host-side `playback_status` poll for EOF when the WebView is hidden (`document.hidden`); ~1 Hz in Rust — started/stopped from `audio-engine.js` `syncEnginePlaybackEofWatchdog`. */
