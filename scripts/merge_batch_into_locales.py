#!/usr/bin/env python3
"""Merge keys from a batch JSON into de/es/sv/fr/nl/pt/it/el/pl/ru/zh/ja/ko/fi using English values for new keys.
...
def main() -> None:
    ...
    for loc in ("de", "es", "sv", "fr", "nl", "pt", "it", "el", "pl", "ru", "zh", "ja", "ko", "fi"):
