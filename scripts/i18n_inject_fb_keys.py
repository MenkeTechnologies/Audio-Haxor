...
NEW_KEYS: dict[str, str] = {
    ...
    # Single missing tooltip surface surfaced by audit.
    "ui.tt.cancel_als_generation": "Cancel ALS generation",
    # ── New command-palette entries from action audit (every data-action
    # surfaced in toolbars / settings forms / player) ──
    "menu.stop_audio_scan": "Stop Audio Scan",
    "menu.stop_daw_scan": "Stop DAW Scan",
    "menu.stop_plugin_scan": "Stop Plugin Scan",
    "menu.stop_preset_scan": "Stop Preset Scan",
    "menu.stop_midi_scan": "Stop MIDI Scan",
    "menu.scan_midi": "Scan MIDI",
    "menu.export_audio_samples": "Export Audio Samples",
    "menu.export_daw_projects": "Export DAW Projects",
    "menu.export_plugins": "Export Plugins",
    "menu.export_presets": "Export Presets",
    "menu.export_favorites": "Export Favorites",
    "menu.export_notes": "Export Notes",
    "menu.export_recently_played": "Export Recently Played",
    "menu.import_audio_samples": "Import Audio Samples",
    "menu.import_daw_projects": "Import DAW Projects",
    "menu.import_plugins": "Import Plugins",
    "menu.import_presets": "Import Presets",
    "menu.import_favorites": "Import Favorites",
    "menu.import_notes": "Import Notes",
    "menu.import_recently_played": "Import Recently Played",
    "menu.favorite_current_track": "Favorite Current Track",
    "menu.tag_current_track": "Tag Current Track",
    "menu.toggle_reverse_playback": "Toggle Reverse Playback",
    "menu.set_ab_loop_start": "Set A-B Loop Start",
    "menu.set_ab_loop_end": "Set A-B Loop End",
    "menu.clear_ab_loop": "Clear A-B Loop",
    "menu.reset_eq": "Reset EQ",
    "menu.reset_shortcuts": "Reset Keyboard Shortcuts",
    "toast.scanning_midi": "Scanning MIDI",
